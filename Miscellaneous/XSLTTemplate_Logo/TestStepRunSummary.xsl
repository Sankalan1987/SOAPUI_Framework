			...
			<TH colspan='4' style='font-family:Copperplate Gothic Bold; font-size:1.4em;'>SOAPUI AUTOMATED TEST EXECUTION SUMMARY</TH>
				...
				<div id="container"> 
                    ...
                    <table align="center" border="1"
                        ...
                        cellspacing="0" height="31" id="table1" width="1800">
                        <tr>
                        ...
                        <tr bgcolor="#687C7D">
							...
							<td width="50">
                                <p align="center">
                                    <b>
                                    <font color="white"
                                    face="Arial Narrow" size="2">Request Header</font>
                                    </b>
                                </p>
                            </td>
                            <td width="50">
                                <p align="center">
                                    <b>
                                    <font color="white"
                                    face="Arial Narrow" size="2">Response Header</font>
                                    </b>
                                </p>
                            </td>
							<!-- <td width="100">
                        ...
                        <xsl:for-each select="testcases/testcase">
                            <tr bgcolor="#EDEEF0">
                                ...
                                <td width="1725">
                                    ...
                                    id="table1" layout="fixed" width="1725">
									...
									<xsl:value-of select="AssertionErrors"/>
                                    </font>
                                    </p>
                                    </td>
                                    <!--2.5.2 Colunmn-->
									...
									<b>
                                    <font
                                    face="Verdana" size="2">Header</font>
									</b>
									</a>
                                    </p>
									</td>
